...
public class DoctorView {
	...
	private void initialize() {
		...
		this.frame1.add(this.title, BorderLayout.NORTH);
		// AppointmentsPanel
		...
		this.frame1.add(this.appointmentsScrollPane, BorderLayout.CENTER);
		this.appointmentCards = new ArrayList<JPanel>();
		int i=0;
		for (; i < this.appointments.size(); i++) {
		...
		this.frame1.add(bottomPanel, BorderLayout.SOUTH);
